# Macros that are invoked by the Mullvad installer and uninstaller.
# The (un)installer is generated by Electron Builder, see its docs for details:
...
#
# This is called by both the installer and uninstaller
#
# Timing:
# - if installer, after customInit and before customInstall
# - if uninstaller, before customUnInit and customRemoveFiles
#
# Do not remove this macro definition. It overrides the default implementation,
...
#
# TODO: Consider using RestartManager to stop the service.
#
...
!macro customRemoveFiles
	...
	${If} ${isUpdated}
		...
		# If the directory is empty, continue update anyway
		${If} $0 == ${MULLVAD_SUCCESS}
			Goto customRemoveFiles_final_cleanup
		${EndIf}
