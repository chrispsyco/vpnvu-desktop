...
import vu.vpn.talpid.model.IpAvailability
import vu.vpn.talpid.util.NetworkEvent
import vu.vpn.talpid.util.UnderlyingConnectivityStatusResolver
import vu.vpn.talpid.util.defaultNetworkEvents
import vu.vpn.talpid.util.hasInternetConnectivity
import vu.vpn.talpid.util.nonVpnInternetNetworksEvents
...
class ConnectivityManagerUtilKtTest {
    ...
    companion object {
        private const val CONNECTIVITY_MANAGER_UTIL_CLASS =
            "vu.vpn.talpid.util.ConnectivityManagerUtilKt"
    }
}
