...
import vu.vpn.lib.map.internal.DISTANCE_DURATION_SCALE_FACTOR
import vu.vpn.lib.map.internal.FAR_ANIMATION_MAX_ZOOM_MULTIPLIER
import vu.vpn.lib.map.internal.MAX_ANIMATION_MILLIS
import vu.vpn.lib.map.internal.MAX_MULTIPLIER_PEAK_TIMING
import vu.vpn.lib.map.internal.MIN_ANIMATION_MILLIS
import vu.vpn.lib.map.internal.SHORT_ANIMATION_CUTOFF_MILLIS
