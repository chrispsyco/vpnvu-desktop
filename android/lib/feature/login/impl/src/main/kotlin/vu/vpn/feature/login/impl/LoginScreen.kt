...
import vu.vpn.common.compose.ACCOUNT_NUMBER_CHUNK_SIZE
import vu.vpn.common.compose.CollectSideEffectWithLifecycle
import vu.vpn.common.compose.accountNumberKeyboardType
import vu.vpn.common.compose.accountNumberOutputTransformation
import vu.vpn.common.compose.accountNumberVisualTransformation
...
import vu.vpn.feature.login.api.ApiUnreachableInfoDialogResult
...
import vu.vpn.lib.ui.component.textfield.mullvadDarkTextFieldColors
...
import vu.vpn.lib.ui.tag.LOGIN_BUTTON_TEST_TAG
import vu.vpn.lib.ui.tag.LOGIN_INPUT_TEST_TAG
import vu.vpn.lib.ui.tag.LOGIN_REVEAL_INPUT_BUTTON_TEST_TAG
import vu.vpn.lib.ui.tag.LOGIN_SCREEN_DELETE_ACCOUNT_HISTORY_TEST_TAG
import vu.vpn.lib.ui.tag.LOGIN_TITLE_TEST_TAG
...
private fun LoginScreen(
    ...
    ScaffoldWithTopBar(
        ...
        Column(
            ...
            // PSYCO · porta do desktop · description sob o title · explicação
