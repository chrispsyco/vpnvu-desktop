...
import vu.vpn.lib.ui.component.griditem.AppIconAndTitleGridItem
...
@Preview
@Composable
private fun PreviewAppIconScreen() {
    AppTheme {
        AppIconScreen(
            state =
                Lc.Content(
...
@Composable
fun AppIcon(navigator: Navigator) {
