package vu.vpn.feature.appicon.impl.obfuscation
 ...
 * (`vu.vpn.feature.appearance.impl.obfuscation`) to preserve the user's icon
...
private const val ACTIVITY_ALIAS_PACKAGE =
    "vu.vpn.feature.appearance.impl.obfuscation"
