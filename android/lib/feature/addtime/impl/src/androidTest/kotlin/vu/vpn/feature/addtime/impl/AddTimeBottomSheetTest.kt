...
class AddTimeBottomSheetTest {
    ...
    @Test
    fun testBuyCreditClick() = composeExtension.use {
        // Arrange
    ...
    @Test
    fun testRedeemVoucherClick() = composeExtension.use {
        // Arrange
        val mockedClickHandler: () -> Unit = mockk(relaxed = true)
        initBottomSheet(
            state =
    ...
    @Test
    fun testShowBillingPaymentAvailable() = composeExtension.use {
        // Arrange
    ...
    @Test
    fun testShowPendingPayment() = composeExtension.use {
        // Arrange
        val mockPaymentProduct: PaymentProduct = mockk()
        every { mockPaymentProduct.price } returns ProductPrice("$10")
    ...
    @Test
    fun testOnPurchaseBillingProductClick() = composeExtension.use {
        // Arrange
    ...
    @Test
    fun testShowPurchaseCompleteDialog() = composeExtension.use {
        // Arrange
    ...
    @Test
    fun testShowVerificationErrorDialog() = composeExtension.use {
        // Arrange
        val productId = ProductId(ProductIds.ThreeMonths)
        initBottomSheet(
            AddTimeUiState(
    ...
    @Test
    fun testShowFetchProductsErrorDialog() = composeExtension.use {
        // Arrange
    ...
    @Test
    fun testShowInternetBlocked() = composeExtension.use {
        // Arrange
        initBottomSheet(
            state =
                AddTimeUiState(
