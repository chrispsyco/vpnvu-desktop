...
import vu.vpn.feature.apiaccess.impl.screen.detail.ApiAccessMethodDetailsSideEffect
...
import vu.vpn.lib.common.util.delayAtLeast
...
class ApiAccessMethodDetailsViewModelTest {
    ...
    companion object {
        private const val DELAY_UTIL = "vu.vpn.lib.common.util.DelayKt"
    }
}
