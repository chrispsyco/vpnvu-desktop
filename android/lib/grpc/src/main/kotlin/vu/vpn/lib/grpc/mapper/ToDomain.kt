...
package vu.vpn.lib.grpc.mapper
...
import vu.vpn.lib.grpc.GrpcConnectivityState
import vu.vpn.lib.grpc.RelayNameComparator
import vu.vpn.lib.model.AccountData
import vu.vpn.lib.model.AccountId
...
import vu.vpn.lib.model.AppVersionInfo
import vu.vpn.lib.model.AuthFailedError
...
import vu.vpn.lib.model.Endpoint
...
import vu.vpn.lib.model.SocksAuth
import vu.vpn.lib.model.SplitTunnelSettings
import vu.vpn.lib.model.TransportProtocol
import vu.vpn.lib.model.TunnelEndpoint
...
internal fun ManagementInterface.ObfuscationSettings.Lwo.toDomain(): LwoObfuscationSettings =
    if (hasPort()) {
