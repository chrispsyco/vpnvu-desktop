package vu.vpn.test.mockapi.server
...
import vu.vpn.test.mockapi.R
import vu.vpn.test.mockapi.constant.ACCOUNT_URL_PATH
import vu.vpn.test.mockapi.constant.AUTH_TOKEN_URL_PATH
import vu.vpn.test.mockapi.constant.CREATE_ACCOUNT_URL_PATH
import vu.vpn.test.mockapi.constant.DEVICES_ID_URL_PATH
import vu.vpn.test.mockapi.constant.DEVICES_URL_PATH
import vu.vpn.test.mockapi.constant.DUMMY_ACCESS_TOKEN
import vu.vpn.test.mockapi.constant.DUMMY_ID_1
import vu.vpn.test.mockapi.constant.RELAY_LIST_URL_PATH
import vu.vpn.test.mockapi.util.accessTokenJsonResponse
import vu.vpn.test.mockapi.util.accountCreationJson
import vu.vpn.test.mockapi.util.accountInfoJson
import vu.vpn.test.mockapi.util.deviceJson
import vu.vpn.test.mockapi.util.tooManyDevicesJsonResponse
