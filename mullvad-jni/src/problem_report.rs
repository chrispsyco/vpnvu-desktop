...
pub extern "system" fn Java_vu_vpn_lib_repository_ProblemReportRepository_collectReport(
    env: JNIEnv<'_>,
    _: JObject<'_>,
...
#[unsafe(no_mangle)]
#[expect(non_snake_case)]
pub extern "system" fn Java_vu_vpn_lib_repository_ProblemReportRepository_sendProblemReport(
    env: JNIEnv<'_>,
    _: JObject<'_>,
    userEmail: JString<'_>,
